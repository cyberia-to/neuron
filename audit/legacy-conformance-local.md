...
Archived original Cell v1 evidence. C-series identifiers below refer to the
2026-09-11 definitions; the current neuron suite has evolved. Current migration
and composition evidence is in [the ledger](../../soft3/audit/neuron-cell/implementation.md).
